...
Students first learn HTTP protocols and build a command-line chatbot that consumes AI APIs, then reverse roles to build their own image classification API server with authentication, database-backed user management, and rate limiting.
